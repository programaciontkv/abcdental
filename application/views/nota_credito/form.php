          ...
          <div class="box box-primary">
            <form id="frm_save" role="form" action="<?php echo $action?>" method="post" autocomplete="off" enctype="multipart/form-data">
              <div class="box-body" >
                          ...
                          <table class="table table-bordered table-striped" id="tbl_detalle">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td colspan="2" id="lb1" align="right"></td>
                                    <td>
                ...
                <input type="hidden" class="form-control" id="ncr_id" name="ncr_id" value="<?php echo $nota->ncr_id?>">
        ...
        obj.value = (obj.value + '').replace(/[^0-9.]/g, '');
         ...
         $('#ncr_motivo').val('');
            ...
            function ocultar() {
                ...
                if ($('#trs_id').val() == '1') {
                  ...
                  $('#lista').html('');
                    ...
                    var clp=($('#valores').attr('colspan')*1);
            ...
            function bloq_1(obj){
               ...
               $('#descuent'+n).attr('readonly', true);
               
            }
             function bloq_2(obj){
                 n=obj.lang;
                 $('#descuento'+n).attr('readonly', true);
            }
             ...
             function calculo_3(obj) {
                ...
                while (n < i) {
                    ...
                    if ($('#item' + n).val() == null) {
                        ...
                        dsc= (round(d,dec) * 100) / round(vtp,dec) ; 
                        console.log(round(vtp,dec));
                        console.log(round(d,dec));
                        console.log(dsc);
                        if(dsc.toFixed(2)=='NaN'){
                          dsc=0;
                        }  
                        $('#descuento' + n).val(dsc.toFixed(dec));
                        $('#valor_total' + n).val(round(d,dec));
                        ob = $('#iva' + n).val();
                        val = $('#valor_total' + n).val().replace(',', '');
                        d = $('#descuent' + n).val().replace(',', '');
                        $('#ice' + n).val(pic.toFixed(dec));
                    ...
                    if (ob == '14') {
                        t12 = (round(t12,dec) * 1 + round(d,dec) * 1);
                        tiva = ((round(tice,dec) + round(t12,dec)) * 14 / 100);
                    }
                ...
                $('#total_iva').val(tiva.toFixed(dec));
                $('#total_ice').val(tice.toFixed(dec));
                $('#total_valor').val(tdsc.toFixed(dec));
            } 
            ...
            function save() {
                        ...
                        if($('#fac_id').val()!='0' && parseFloat($('#saldo').val())<parseFloat($('#total_valor').val())){
                           swal("Error!", "No se puede Guardar \nLa nota supera el Saldo de la Factura $" + $('#saldo').val()+"!", "error");
                          return false;
                        }
