                  ...
                  <td class="col-sm-10">
                    ...
                    <tr>
                       <td class="col-sm-16" colspan="2">
                          ...
                          <table class="table table-bordered table-striped" width="100%"  id="tbl_detalle">
                            <thead>
                              <tr>
                                <th hidden>Item</th>
                                <th hidden>Codigo</th>
                                  ...
                                  ?>
                                    <tr>
                                        <td  colspan="1">
                                            ...
                                            <select style="width:150px;" id="busqueda" name="budqueda" placeholder="Seleccione un producto.." lang="1" onchange="load_producto(this.lang)">
                                                           
                                                            <?php
                                                     foreach ($cns_productos as $rst_pro) {
                                                         ?>
                                                            <option value="<?php echo $rst_pro->mp_d ?>">
                                                                <?php echo $rst_pro->mp_c . ' ' . $rst_pro->mp_d ?>
                                                            </option>
                                                            <?php
                                                     }
                                                        ?>
                                        ...
                                        <td hidden >
                                            <input style="text-align:left " type ="text" size="7" class="refer form-control"  id="pro_referencia" name="pro_referencia"   value="" lang="1" readonly style="width:300px;" />
                                        ...
                                        <td>
                                          <input type ="text" size="7"  style="text-align:right" id="cantidad" name="cantidad"  value="0" lang="1" onchange="calculo_encabezado(this), validar_inventario(this), costo(this)" class="form-control decimal" />
                                        </td>
                                        <td width="100px">
                                ...
                                <tbody id="lista">
                                  ...
                                  $n=0;
                                    foreach($cns_det as $rst_det) {
                                        ...
                                        ?>
                                        <tr>
                                            <td hidden id="item<?PHP echo $n ?>" name="item<?PHP echo $n ?>" lang="<?PHP echo $n ?>" align="center"><?PHP echo $n ?></td>
                                            <td id="pro_descripcion<?PHP echo $n ?>" name="pro_descripcion<?PHP echo $n ?>" lang="<?PHP echo $n ?>"><?php echo $rst_det->pro_codigo ?></td>
                                            <td style="width:20px" id="pro_referencia<?PHP echo $n ?>" name="pro_referencia<?PHP echo $n ?>" lang="<?PHP echo $n ?>"><?php echo $rst_det->pro_descripcion ?>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td valign="top" rowspan="9" colspan="<?php echo $col_obs?>">
                                      <textarea style="height: 80px; width: 70%;" id="observacion" name="observacion"   onkeydown="return enter(event)" maxlength="250" ><?php echo $factura->fac_observaciones ?></textarea>
                                    </td>    
                                ...
                                <tr hidden >
                                    ...
                                    <td colspan="1"><input style="text-align:right" type="text" class="form-control" id="subtotalex" name="subtotalex" value="<?php echo str_replace(',', '', number_format($factura->fac_subtotal_ex_iva, $dec)) ?>" readonly/>
                                    </td>
                                </tr>
                                <tr hidden>
                                    <td colspan="2" align="right">Subtotal no objeto de Iva:</td>
                                    <td colspan="1"><input style="text-align:right" type="text" class="form-control" id="subtotalno" name="subtotalno" value="<?php echo str_replace(',', '', number_format($factura->fac_subtotal_no_iva, $dec)) ?>" readonly/>
                                    </td>
                                </tr>
                                <tr >
                                    <td colspan="2" align="right">Subtotal sin Impuestos:</td>
                                    <td colspan="1"><input style="text-align:right" type="text" class="form-control" id="subtotal" name="subtotal" value="<?php echo str_replace(',', '', number_format($factura->fac_subtotal, $dec)) ?>" readonly/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="right">Total Descuento:</td>
                                    <td colspan="1"><input style="text-align:right" type="text" class="form-control" id="total_descuento" name="total_descuento" value="<?php echo str_replace(',', '', number_format($factura->fac_total_descuento, $dec)) ?>" readonly/>
                                    </td>
                                </tr>
                                <!-- <tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="1"><input style="text-align:right" type="text" class="form-control" id="total_iva" name="total_iva" value="<?php echo str_replace(',', '', number_format($factura->fac_total_iva, $dec)) ?>" readonly />
                                    </td>
                                </tr> 
                                <tr>
                                    <td colspan="2" align="right">Propina:</td>
                                    <td colspan="1"><input type="text" class="form-control" id="total_propina" name="total_propina" value="<?php echo str_replace(',', '', number_format($factura->fac_total_propina, $dec)) ?>"  style="text-align:right" onchange="calculo()"/>
                                        
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2" align="right">Total Valor:</td>
                                    <td colspan="1"><input style="text-align:right;font-size:15px;color:red  " type="text" class="form-control" id="total_valor" name="total_valor" value="<?php echo str_replace(',', '', number_format($factura->fac_total_valor, $dec)) ?>" readonly />
                    ...
                    <tr>
                      <div class="box-body">
                          ...
                          <table  class="table-bordered table-striped" id="tbl_pagos" >
                            ...
                            <tbody>
                              ...
                              ?>
                                ...
                                <?php 
                                  ...
                                  ?>
            <td >
              <input type="button" name="add1" id="add1" onclick="validar('#tbl_pagos','1')" lang="1" class="btn btn-primary " value="+">
              ...
              <div class="box-footer">
                <button type="button" class="btn btn-primary" onclick="save()" id="guardar">Guardar</button>
            ...
            function clona_detalle(table,opc) {
                ...
                if (d == 0) {
                    ...
                    var fila = "<tr>"+
                                        ...
                                        "</td>"+
                                        "<td hidden id='pro_descripcion"+i+"' lang='"+i+"'>"+pro_descripcion.value+"</td>"+
                                        ...
                                        "<td style='width:25px'>"+
                                          "<input type ='text' class='form-control decimal' size='10' style='text-align:right' id='cantidad"+i+"' name='cantidad"+i+"' lang='"+i+"' onchange='validar_inventario_det()'  value='"+cantidad.value +"' onkeyup='validar_decimal(this)'/>"+
                                        "</td>"+
                                        "<td style='width:50px'>"+
                                          "<input type ='text' size='10' style='text-align:right' id='pro_precio"+i+"' name='pro_precio"+i+"' onchange='calculo()' value='"+pro_precio.value+"' lang='"+i+"' class='form-control decimal' onkeyup='validar_decimal(this)' "+r_precio+" />"+
                                        "</td>"+
                                        "<td style='width:50px'>"+
                                          "<input type ='text' size='10'  style='text-align:right' id='descuento"+i+"' name='descuento"+i+"'  lang='"+i+"' onchange='calculo()' class='form-control decimal' value='"+descuento.value+"' onkeyup='validar_decimal(this)' "+r_descuento+"/>"+
                                        "</td>"+
                                        "<td hidden>"+
                        ...
                        if (j > 0) {
                            ...
                            while (n < j) {
                                ...
                                if(inven==0 && ($('#pro_ids').val()=='26' || $('#pro_ids').val()=='69') ){  
                                  if (parseFloat($('#inventario').val()) < parseFloat(cant)) {
                                      ///alert('NO SE PUEDE REGISTRAR LA CANTIDAD\n ES MAYOR QUE EL INVENTARIO');
                                       swal("Error!", "NO SE PUEDE REGISTRAR LA CANTIDAD. ES MAYOR QUE EL INVENTARIO.! Cantidad disponible "+cant, "error");
                ...
                //       n++;
                      ...
                      if ($('#pro_aux').val() !=null) {
                        ...
                        $.ajax({
                          ...
                          success: function (dt) {
                            if($('#fprecio').val()=='1'){
                              if (dt.pro_precio.trim().length == 0) {
                                $('#pro_precio').val('0');
                              } else {
                                $('#pro_precio').val(parseFloat(dt.pro_precio).toFixed(dec));
                              }
                              ...
                              if (dt.pro_precio2.trim().length == 0 ||  dt.pro_precio2.trim().length == null ) {
                                $('#pro_precio').val('0');
                              } else {
                                  $('#pro_precio').val(parseFloat(dt.pro_precio2).toFixed(dec));
                              }
